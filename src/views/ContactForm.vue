...
export default {
  ...
  setup() {
    ...
    return {
      ...
      cloud: computed(() => contactForm.value[0][4].value),
      venture: computed(() => contactForm.value[0][5].value),
      licenses: computed(() => contactForm.value[0][6].value),
      dk: computed(() => contactForm.value[0][7].value),
      loading,
      authStore,
      error,
      success,
